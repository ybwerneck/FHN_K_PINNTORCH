...
trainer.add_loss(FHN_loos_fromDataSet(data_folder,10240,device=device,loss_type="L4"),weigth=1)
trainer.add_loss(FHN_loos_fromDataSet(data_folder,10240,device=device,loss_type="L2"),weigth=1)
